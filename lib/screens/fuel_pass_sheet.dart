...
class _FuelPassSheetState extends State<FuelPassSheet> {
  ...
  Future<void> _loadQuota() async {
    ...
    try {
      // For shared vehicles, we need to get quota for the shared user
  ...
  Future<void> _generateToken() async {
    ...
    // For shared vehicles, we need to generate token for the owner's vehicle
    // But the QR code should be generated by the owner
    if (widget.isSharedVehicle) {
      // For shared vehicles, we show a message that only owner can generate QR
      setState(() {
        _errorMessage =
            'Only the vehicle owner can generate the Fuel Pass QR code. Please contact ${widget.vehicle.make} ${widget.vehicle.model} owner.';
        _isLoading = false;
        _isRefreshing = false;
      });
      return;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // Header with shared vehicle badge
            Padding(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget.isSharedVehicle)
                          Text(
                            'Shared by owner • You can view quota',
                            style: GoogleFonts.inter(
                              fontSize: 11,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    // Timer indicator (only for owner)
                    if (!widget.isSharedVehicle)
                      Container(
                    ...
                    // Passcode display (only for owner)
                    if (!widget.isSharedVehicle &&
