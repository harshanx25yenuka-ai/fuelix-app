...
class ApiService {
  ...
  Future<Map<String, dynamic>> generateDynamicQr(int vehicleId) async {
    try {
      ...
      final response = await http
          .post(
            Uri.parse('$baseUrl/vehicles/$vehicleId/dynamic-qr'),
            headers: {
  ...
  Future<Map<String, dynamic>> staffVerifyQrV2(String qrData) async {
    try {
      ...
      final response = await http
          .post(
            Uri.parse('$baseUrl/vehicles/staff-verify-v2'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
  ...
  Future<Map<String, dynamic>> completeRefill({
    ...
    required Map<String, dynamic> fuelLogData,
  }) async {
    try {
      final token = await getToken();
      if (token == null) {
      ...
      final response = await http
          .post(
            Uri.parse('$baseUrl/vehicles/complete-refill'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
  ...
  Future<Map<String, dynamic>> invalidateToken(String tokenId) async {
    try {
      ...
      final response = await http
          .delete(
            Uri.parse('$baseUrl/vehicles/qr-token/$tokenId'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
  ...
  Future<Map<String, dynamic>> declineInvitation(int familyId) async {
    try {
      ...
      final response = await http
          .post(
            Uri.parse('$baseUrl/family/decline'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
  ...
  Future<Map<String, dynamic>> getPendingInvitations() async {
    try {
      ...
      final response = await http
          .get(
            Uri.parse('$baseUrl/family/pending-invitations'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {
          'success': false,
          'error': data['error'] ?? 'Failed to get invitations',
        };
      }
    } catch (e) {
      return {'success': false, 'error': 'Network error: $e'};
  ...
  Future<Map<String, dynamic>> hasVehiclePass() async {
    try {
      final token = await getToken();
      if (token == null) {
        return {'success': false, 'hasVehiclePass': false};
      }

      final response = await http
          .get(
            Uri.parse('$baseUrl/vehicles/has-vehicle-pass'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
